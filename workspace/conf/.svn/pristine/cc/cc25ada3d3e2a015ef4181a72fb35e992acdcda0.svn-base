...
$(function() {
	...
	bootstrapTable_init("#menuslist", basepath + "/menus/menus_list.do");
...
/**
 * tableid tableID dataurl 数据集 searchids 控件ID (注意要与controller获取参数名一致)
 */
...
function break_table(parenttableid, showurl) {
	...
	$('#' + parenttableid).bootstrapTable('refresh', {
		url : showurl
	})
}
