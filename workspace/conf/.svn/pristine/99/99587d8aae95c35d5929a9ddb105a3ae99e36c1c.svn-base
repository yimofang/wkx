...
<body class="gray-bg">
							...
							<div class="example">
                                ...
                                <c:if test="${upd!=null && upd=='upd'}">
									<button class="btn btn-info" type="button"
										onclick="update_obj()" id="update_btn">修改</button>
								</c:if>
								<c:if test="${del!=null && del=='del'}">
									<button class="btn btn-danger" type="button"
										onclick=" delete_obj()" id="delete_btn">删除</button>
								</c:if>
					
								<div class="" style="">

									<button class="btn btn-primary" type="button"
										onclick="refreshtable('briefmedialist','/briefmedia/table_init.do',['select','startdate','overdate'])"
									...
									<div class="col-sm-2" style="float: right; margin-top: -8px;">
										搜索框： <input id="select" name="wishing" type="text"
											class="form-control" placeholder="搜索推广简报">
									</div>
								...
								<table id="briefmedialist" data-height="557" class="table">
									<thead>
										<tr>
											...
											<th data-field="bphone"  >联系电话</th>
                                            <th data-field="bname"  >推广简报</th>
                                             <th data-field="mediastr"  >推广媒体</th>
	...
	<script type="text/javascript">
		...
		var table_obj = $("#briefmedialist"); //当前操作的 table
	 ...
	 <!-- 引入form表单页 -->
<jsp:include page="briefmedia_form.jsp"></jsp:include>
</body>
