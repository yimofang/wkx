...
$(function() {
	...
	//alert("1111");
	bootstrapTable_init("#confssubuserlist", basepath+"/confssubuser/table_init.do?confsid="+$("#confsid").val());
	bootstrapTable_init("#confslist", basepath+"/confs/table_init.do");
	bootstrapTable_init("#confstypelist", basepath+"/confstype/table_init.do");
	bootstrapTable_init("#msglist", basepath+"/msg/table_init.do");
	bootstrapTable_init("#briefmedialist", basepath+"/briefmedia/table_init.do");
	bootstrapTable_init("#medialist", basepath+"/media/table_init.do");
	bootstrapTable_init("#adminloglist", basepath+"/adminlog/adminlog_list.do");
	bootstrapTable_init("#conductlist", basepath+"/conduct/table_init.do");
	bootstrapTable_init("#loglist", basepath+"/log/table_init.do");
...
function refreshtable(tableid,dataurl,searchids){
	...
	//  console.log(parameters);//页面控制台输出
