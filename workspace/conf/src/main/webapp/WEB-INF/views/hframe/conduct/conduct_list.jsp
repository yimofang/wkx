...
<body class="gray-bg">
					...
					<div class="col-sm-12">
						...
						<div class="example-wrap">
							<div class="example">
								...
								<table id="conductlist" data-height="557" class="table">
									<thead>
										<tr>
											...
											<th data-field="symbol" data-sortable="true">标签</th>
	...
	<script type="text/javascript">
		...
		var table_obj = $("#conductlist"); //当前操作的 table
	...
	<!-- 导入from 表单页 -->
	<jsp:include page="conduct_form.jsp" />
