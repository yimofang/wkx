		...
		<div class="ibox-content">
			<form class="form-horizontal m-t" id="commentForm"
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<textarea rows="" cols="" id="brief" name="brief"
...
<script type="text/javascript">
	...
	var method_path = base_path_from + "/media";
		...
		if (se == true){
			$.ajax({
				...
				success : function(data) {//返回数据根据结果进行相应的处理  
					...
					//移除 删除行
					$("#medialist").bootstrapTable('remove', {
						field : 'id',
	...
	function frominit(data, state) {
		...
		if (state == 1) {//初始化
			...
			$("#bname").val(data.row.mname);
			$("#brief").val(data.row.brief);
