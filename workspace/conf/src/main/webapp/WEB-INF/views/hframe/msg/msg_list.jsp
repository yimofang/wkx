...
<body class="gray-bg">
					...
					<div class="col-sm-12">
						...
						<div class="example-wrap">
							<div class="example">
								...
								<div class="" style="">
									<button class="btn btn-primary" type="button"
										onclick="refreshtable('msglist','/msg/table_init.do',['select','startdate','overdate'])"
								...
								<table id="msglist" data-height="557" class="table">
									<thead>
										<tr>
	...
	<script type="text/javascript">
		...
		var table_obj = $("#msglist"); //当前操作的 table
