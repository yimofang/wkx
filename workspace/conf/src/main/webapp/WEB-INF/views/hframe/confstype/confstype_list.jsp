...
<body class="gray-bg">
				...
				<div class="row row-lg">
					...
					<div class="col-sm-12">
					 ...
					 <!--
								<div class="" style="">
									<button class="btn btn-primary" type="button"
										onclick="refreshtable('confstypelist','/confstype/table_init.do',['select'])"
 ...
 -->
								...
								<table id="confstypelist" data-height="557" class="table">
									<thead>
										<tr>
											...
											<th data-field="tname" data-sortable="true">标题</th>
	...
	<script type="text/javascript">
		...
		var table_obj = $("#confstypelist"); //当前操作的 table
	...
	<!-- 导入from 表单页 -->
	<jsp:include page="confstype_form.jsp" />
