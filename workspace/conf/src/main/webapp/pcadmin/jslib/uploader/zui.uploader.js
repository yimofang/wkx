...
(function($, window, Plupload, Moxie, undefined) {
    ...
    var NAME = 'zui.uploader', // modal name
        FILE_TEMPLATE = '<div class="file"><div class="file-progress-bar"></div><div class="file-wrapper"><div class="file-icon"><i class="fa fa-file-o"></i></div><div class="content"><div class="file-name"></div><div class="file-size small text-muted">0KB</div></div><div class="actions"><div class="btn file-status" data-toggle="tooltip"><i class="fa"></i> <span class="text"></span></div><a data-toggle="tooltip" class="btn btn-link btn-download-file" target="_blank"><i class="fa fa-download-alt"></i></a><button type="button" data-toggle="tooltip" class="btn btn-link btn-reset-file" title="Repeat"><i class="fa fa-repeat"></i></button><button type="button" data-toggle="tooltip" class="btn btn-link btn-rename-file" title="Rename"><i class="fa fa-pencil"></i></button><button type="button" data-toggle="tooltip" title="Remove" class="btn btn-link btn-delete-file"><i class="fa fa-trash text-danger"></i></button></div></div></div>',
        DEFAULTS = {
            // qiniu: {
            //     uptoken_url,
            //     uptoken,
    ...
    Uploader.prototype.createFileIcon = function(file) {
        ...
        return '<i class="fa fa-' + icon + ' file-icon-' + ext + '" data-type="' + fileType + '"' + (ext ? ' data-ext="' + ext + '"' : '') + '></i>';
    };
