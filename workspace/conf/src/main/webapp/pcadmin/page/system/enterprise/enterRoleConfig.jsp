		<script type="text/javascript">var roleId = <%=request.getParameter("roleId")==""?"null":request.getParameter("roleId")%>;</script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/enterprise/enterRoleConfig.js"></script>
		...
		<div style="height:560px;width:100%;overflow-y:scroll;">
			<div class="container-fluid animated fadeInLeft" style="padding-left: 35px;padding-right: 35px;padding-top: 10px;">
				<form id="enterMenuFunctionInfo" >
					<input type="hidden" name="roleId" id="roleId" value="">
					<div id="enterMenuFunctionList"></div>
				</form>
			</div>
		</div>
		<div class="pull-right"style="position:absolute;bottom:0;right:60px">
			<button style="margin-right: 5px;" type="button" class="btn btn-primary" onclick="submitEnterRoleConfig()">
