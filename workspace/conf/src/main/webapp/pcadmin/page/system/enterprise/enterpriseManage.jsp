<!-- 首页-主菜单-权限管理-企业管理管理页 -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/enterprise/enterpriseManage.js"></script>
	...
	<div class="col-lg-12 dri-row" style="height:860px;overflow:scroll">
		...
		<div class="dri-panel panel-success">
			...
			<div class="panel-body panel-collapse collapse">
				<!-- 搜索表单 -->
				<form id="enterpriseSearch"  class="form-horizontal">
					<!-- 多行搜索项 -->
					<div class="form-group" style="margin-bottom: 5px;">
					    <label for="flowname" class="col-sm-1 control-label">企业名称</label>
					    <div class="col-sm-3">
					     	 <input type="text" class="form-control" id="entername" name="entername" placeholder="请输入要搜索的名称">
					    </div>
					</div>
					...
					<div class="form-group form-inline" style="margin-bottom: 5px;">
					    ...
					    <div class="col-lg-11">
							<button class="btn dribbble-btn dribbble-btn-primary btn-lg" type="button" onclick="searchForEnter()">
        ...
        <div class="dri-panel panel-info">
        	...
        	<div class="panel-body" style="padding-top: 0px;">
        		<table id="enterpriseList" >
        			<div id="addEnterpriseBar">			
						<a class="btn dribbble-btn dribbble-btn-primary btn-xs dri-animate-vertical hidden-xs" id="addorgan" onclick="enterpriseManageTag('添加企业')">
