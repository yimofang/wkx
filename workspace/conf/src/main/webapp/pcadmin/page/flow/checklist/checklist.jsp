<!-- 首页-主菜单-配置管理-隐患排查清单管理页 -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/flow/checklist/checklist.js"></script>
	<script>
	layui.use('laydate', function(){
		  layui.laydate.render({
		    elem: '#checklistSearch #beginTime', //指定元素
		    type: 'datetime'
		  });
		  layui.laydate.render({
		    elem: '#checklistSearch #endTime', //指定元素
		    type: 'datetime'
		  });
		});
	</script>
	<div class="col-lg-12 dri-row" style="height:860px">
		...
		<div class="dri-panel panel-success">
			...
			<div class="panel-body panel-collapse collapse">
				<!-- 搜索表单 -->
				<form id="checklistSearch"  class="form-horizontal">
					<!-- 多行搜索项 -->
					...
					<div class="form-group" style="margin-bottom: 5px;">
					    ...
					    <div class="col-sm-11">
	                        <a class="btn dribbble-btn dribbble-btn-primary btn-lg" onclick="searchForchecklist()">
