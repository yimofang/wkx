<script type="text/javascript" src="${pageContext.request.contextPath}/js/flow/task/xcrwlu.js"></script>
...
console.log(node_id);console.log(typeStyle);console.log(btn);
</script>
