<!-- 首页-培训考试-培训资料修改页 -->
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/exam/trainingUpdate.js"></script>
	...
	<div style="height:430px;width:100%;overflow-y:scroll;" id="organizationTag">
		<div class="container-fluid animated fadeInLeft" style="padding-left: 30px;padding-right: 45px;padding-top: 10px;">
			<form id="trainingInfo" >
				...
				<input type="text" id="video" name="video" lay-verify="title" autocomplete="off" placeholder="视频资料名称" class="layui-input form-control">
