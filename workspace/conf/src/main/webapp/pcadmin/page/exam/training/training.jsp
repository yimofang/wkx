<!-- 首页-主菜单-培训考试-培训资料页  id:id,path:path var path = <!--%=request.getParameter("path")%>;-->
		<script type="text/javascript">
		var path= $.myMethod.getCurTab().path;
		//alert("=="+contextPath);
		</script>
<%
...
%>
	<script type="text/javascript" src="${scrPath}/pcadmin/js/exam/training.js"></script>

	<div class="col-lg-12 dri-row" style="height:860px;overflow:scroll">
		<!-- 上部分搜索区 -->
		<div class="dri-panel panel-success">
				<div class="panel-heading" onclick="$.myMethod.toggleAfterDiv(this)">搜索区${scrPath}
        	...
        	<div class="panel-body" style="padding-top: 0px;">
        		<table id="organizationList" >
        			<div id="addOrganizationBar">			
						<a class="btn dribbble-btn dribbble-btn-primary btn-xs dri-animate-vertical hidden-xs" id="addorgan" onclick="organizationTag('添加资料')">
