...
public class DesEncryption {
	...
	public static void main(String[] args) {
		try {
			String test1 = "http://192.168.2.209:8080/conf/login_web.do?name=xilongfei&pass=123456";
			DesEncryption des1 = new DesEncryption();// 使用默认密钥
			...
			DesEncryption des2 = new DesEncryption("leeme32nz");// 自定义密钥
