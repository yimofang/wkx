...
public class RegexUtils {
	 ...
	 * @return
	 */
	public static boolean checkNubLetter(String mobile) {
		// String regex = "(\\+\\d+)?1[3458]\\d{9}$";
		String regex = "[0-9a-zA-Z]{2,32}";
	...
	/**
	 * 用不严格的方式验证电话号码。只要电话号码由数字或者数字加"-"(最多两个"-")组 *合构成，均符合。比如：400-823-823， 95555,
	 * 010-81567415,
	 * 
	 * @param phone
	 * @return
	 */
	public static boolean lenientTel(String phone) {
		//String regex = "/^([0-9]{1,9}(\\-)?)?([0-9]{1,9}){1}(\\-[0-9]{1,9})?$/";
		Pattern pattern = Pattern.compile("^([0-9]{1,9}(\\-)?)?([0-9]{1,9}){1}(\\-[0-9]{1,9})?$");  
	 ...
	 * @return 验证成功返回true，验证失败返回false
	 */
	public static boolean checkNumber(String card) {
		String regex = "^\\d+$";
		return Pattern.matches(regex, card);
	}
